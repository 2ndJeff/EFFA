...
**BEFORE:**
```
Home | For Universities | About | Job Ready Podcast | Contact | Blog | Log In | Request Demo
```

**AFTER:**
```
For Universities | About | Job Ready Podcast | Contact | Blog | Log In | Request Demo
```

**Key Changes:**
- ❌ Removed "Home" link from navigation
- ✅ EFFA logo now links to https://www.effa.io/ (serves as home button)
...
**AFTER:**
- **Left Column:** 
  - EFFA logo (links to https://www.effa.io/)
...
- **Right Side (3 columns):**
  ...
  - **Resources:** Job Ready Podcast, Log In, Request Demo
...
- [ ] EFFA logo in footer links to https://www.effa.io/
...
**Action:** Create https://www.effa.io/blog when ready
...
- Made logo clickable (links to https://www.effa.io/)
